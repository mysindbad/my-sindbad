(function initSharedNavigation() {
  ...
  const pages = [
    ...
    { id: 'map', href: './map.html', key: 'nav_map', label: '', icon: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m9 20-5.4-2.7A1 1 0 0 1 3 16.4V5.6a1 1 0 0 1 1.4-.9L9 7m0 13 6-3m-6 3V7m6 10 4.6 2.3a1 1 0 0 0 1.4-.9V7.6a1 1 0 0 0-.6-.9L15 4m0 13V4M15 4 9 7"/></svg>' },
