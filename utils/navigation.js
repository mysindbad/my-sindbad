(function initSharedNavigation() {
  ...
  const pages = [
    ...
    { id: 'community', href: './community.html', key: 'nav_community', label: '', icon: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0"/><path d="M16 5a3 3 0 0 1 0 6"/><path d="M21 20a6 6 0 0 0-4-5.6"/></svg>' },
